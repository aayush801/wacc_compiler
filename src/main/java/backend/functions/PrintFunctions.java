...
public class PrintFunctions {
  ...
  public static PrimitiveLabel printString(ProgramGenerator program) {
    ...
    // 		ADD r2, r0, #4
    instructions.add(new Arithmetic(ArithmeticOpcode.ADD, program.registers.get(2), program.registers.get(0), new ImmediateNum(4),false));
    ...
    //		MOV r0, #0
    instructions.add(new Move(program.registers.get(0), new ImmediateNum(0)));
  ...
  public static PrimitiveLabel printBool(ProgramGenerator program) {
    List<Instruction> instructions = new ArrayList<>();
    //		CMP r0, #0
    instructions.add(new Compare(program.registers.get(0), new ImmediateNum(0)));
